...
# Define rooms in the Death Star maze, with 20 rooms now
rooms = {
    "hangar_bay": {
...
# Example of accessing room details
room_name = "hangar_bay"
room = rooms[room_name]
print(f"Room Description: {room['desc']}")
print(f"Item in the room: {room['item']}")
print(f"Exits: North -> {room.get('north')}, South -> {room.get('south')}, East -> {room.get('east')}, West -> {room.get('west')}")
